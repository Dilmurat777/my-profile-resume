          ...
          <div className="w-full lgl:w-[60%] h-full py-10 bg-gradient-to-r from-[#1e2025] to-[#23272b] flex flex-col gap-8 p-8 rounded-lg shadow-shadowOne">
            <form className="w-full flex flex-col gap-6">
              ...
              <div className="w-full">
                <button
                  onClick={handleSend}
                  className="w-full h-12 bg-[#141518] rounded-lg text-base text-gray-400 tracking-wide uppercase hover:text-white duration-300 hover:border-designColor border-transparent">
                  Send Message
                </button>
              </div>
