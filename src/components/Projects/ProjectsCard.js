...
const ProjectsCard = ({ src, title, des, icon }) => {
  return (
    <div className="w-full xl:px-12 px-4 h-auto xl:py-10 py-6 rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 transition-colors duration-1000">
